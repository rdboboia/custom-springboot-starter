package es.rdboboia.custom.starter.extensions;
...
/**
 * Implements {@link AfterEachCallback} to verify that there are no more interactions than the
 * expected ones which are defined by the when-then instructions.
 */
